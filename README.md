...
LEAFLET → Responsável pela coleta da geolocalização em tempo real e renderização dos mapas.

Mapbox → Responsável por realizar o _autocomplete_ do endereço passado pelo o usuário no caso (endereco_coleta e endereco_entrega) e também responsável pela geolocalização reversa
